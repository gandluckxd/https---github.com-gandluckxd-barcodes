...
class ProductInfo(BaseModel):
    ...
    orderitems_name: Optional[str] = Field(None, description="Наименование элемента заказа")
    qty: Optional[int] = Field(None, description="Общее количество изделий")
    ...
    glass_orderitems_id: Optional[int] = Field(None, description="ID стеклопакета в ORDERITEMS")
